...
const AU={
  ...
  pump(){
    ...
    while(this.mus.next<this.now()+0.25){
      ...
      const leadVol=kind==='cave'?0.075:(kind==='lava'?0.102:(kind==='night'?0.10:(kind==='desert'?0.066:(kind==='city'?0.060:(kind==='day2'?0.060*accent:0.07)))));
      const leadLen=kind==='cave'?stepDur*2.55:(kind==='lava'?stepDur*2.25:(kind==='desert'?stepDur*(i%8===0?1.65:1.05):(kind==='city'?stepDur*0.82:(kind==='day2'?(i%16===14?stepDur*1.55:(i%4===0?stepDur*1.10:stepDur*0.82)):stepDur*0.95))));
