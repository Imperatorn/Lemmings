...
const UNDERWATER_CAVE_SCENES={
  ...
  siltTunnel:{
    ...
    objects:[
      {id:'shellEcho',kind:'shell',label:'Ekosnäckan',default:{x:246,y:158,near:false,pulseT:0,hintT:0,hintLines:['UR SNÄCKAN HÖRS ETT SVAGT DROPPANDE','DET FINNS LUFT LÄNGRE IN']},hit:{type:'ellipse',rx:34,ry:22},verbs:['look','touch']}
    ]
  },
  airBell:{
    id:'airBell',
    ...
    objects:[
      {id:'airPocket',kind:'airPocket',label:'Luftfickan',default:{x:244,y:96,near:false,pulseT:0,hintT:0,hintLines:['EN FICKA AV LUFT UNDER STENTAKET','HÄR ÄR DET STILLA EN STUND']},hit:{type:'ellipse',rx:62,ry:34},verbs:['rest']}
    ]
  },
  crystalReef:{
    id:'crystalReef',
    ...
    objects:[
      {id:'blueCrystal',kind:'crystal',label:'Blå kristall',default:{x:258,y:202,near:false,pulseT:0,hintT:0,hintLines:['KRISTALLENS LJUS FALLER ÖVER RISTNINGAR','SAMMA TECKEN SOM I ARKIVEN PÅ LAND']},hit:{type:'ellipse',rx:40,ry:42},block:{type:'ellipse',rx:34,ry:26,dy:8},blocker:true,verbs:['look','touch']}
    ]
  },
  sunkenArchive:{
    id:'sunkenArchive',
    ...
    objects:[
      {id:'sealedRunes',kind:'sealedRunes',label:'Djuparkivet',default:{x:242,y:174,near:false,pulseT:0,hintT:0,hintLines:['TIO ARK VILAR BAKOM GLASET','DE SISTA SPÅREN AV HEMVÄGEN']},hit:{type:'rect',w:136,h:60,dy:-6},verbs:['read']}
    ]
  }
};
...
const UNDERWATER_CAVE_DEEP_RUNE_SET={
  ...
  readLines:['De sista orden om hemvägen.','Tecknen vaknar i det heliga ljuset.'],
  runes:[
    {id:'deep01',title:'Det förlorade arkivet',lines:['Djupruna 1/10','Stormen tog arkivet, men orden finns kvar.']},
    {id:'deep02',title:'Hemvägen',lines:['Djupruna 2/10','Det här är slutet på vår berättelse om hemvägen.']},
    {id:'deep03',title:'Ovanför stormen',lines:['Djupruna 3/10','Vårt hem står kvar, högt ovanför ovädret.']},
    {id:'deep04',title:'Trädgårdarna',lines:['Djupruna 4/10','Där växer blommor i trädgårdar bland molnen.']},
    {id:'deep05',title:'De som väntar',lines:['Djupruna 5/10','Där väntar vänner som inte glömt oss.']},
    {id:'deep06',title:'Världens kant',lines:['Djupruna 6/10','Vid världens sista kant börjar vägen upp.']},
    {id:'deep07',title:'Den brutna vägen',lines:['Djupruna 7/10','Mellan molnen finns ännu spår av den gamla vägen.']},
    {id:'deep08',title:'Broarna',lines:['Djupruna 8/10','Bygg där den brustit, så kan flocken följa.']},
    {id:'deep09',title:'Den sista sträckan',lines:['Djupruna 9/10','Tio sträckor genom himlen återstår till hemmet.']},
    {id:'deep10',title:'Hemkomsten',lines:['Djupruna 10/10','Följ molnvägen hem. Det finns plats för er alla.']}
  ]
};
